...
public class IsGreaterOrEqualsThansTests
{
    [Fact]
    public void DateTime_ReturnDomainException()
    {
        ...
        // Act && Assert
        var exception = Assert.Throws<DomainException>(() => DomainAssertions.IsGreaterOrEqualsThan(value, comparer, randomMessage));
